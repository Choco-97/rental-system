...
<body>
	...
	<form action="cuslist.php" method="post">
			...
			if (isset($_POST['search'])) 
		{
			...
			$sql = $sql = "select * from contact where 
				...
				{ 
					...
					echo "<div class='user-item'>";
                            ...
                            echo "<div class='user-details'>";
	                            ...
	                            echo "<span class='user-info'>Phoneno: ".$record['phno']."</span>";
	                            echo "<span class='user-info'>Message: ".$record['note']."</span>";
...
?>
	...
	<?php
		...
		$sql = "select * from contact"; //all users only
...
function showConfirm(id) {
    if(confirm("Are you sure you want to delete?")) {
        window.location.href="contactlist.php?id="+id;  // Ensure 'id' matches the PHP script
    }
}
