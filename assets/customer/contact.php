...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name)) {
        ...
        $sql = "INSERT INTO contact (name, email, phno, note) VALUES ('$name', '$email', '$phno', '$note')";
        if (mysqli_query($connection, $sql)) {
            echo "<script>
                    alert('Your Contact Message is submitted!');
      ...
      <div class="row">
        <div class="col-md-6">
          <form action="contact.php" method="POST">
            <div>
              <input type="text" name="conname" placeholder="Name" required />
            </div>
            <div>
              <input type="email" name="conemail" placeholder="Email" required />
            </div>
            <div>
              <input type="text" name="conphono" placeholder="Phone" required />
            </div>
            <div>
              <input type="text" name="note" class="message-box" placeholder="Message" required />
            </div>
            <div class="d-flex ">
              <button>
                SEND
